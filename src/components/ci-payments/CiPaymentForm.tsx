                                  ...
                                  render={({ field }) => (
                                      <Select 
                                         onValueChange={(value) => {
                                             ...
                                             const selectedAgent = availableAgents.find(agent => agent.user_id === value);
                                             setValue('paying_agent_printed_name', selectedAgent ? selectedAgent.name : '');
                                         }} 
                                         value={field.value || ""}
                                     > 
                                          <SelectTrigger>
                                          ...
                                          <SelectContent>
                                              ...
                                              {agentData && <SelectItem value={userId}>{agentData.name} (Myself)</SelectItem>}
                                              {/* List other agents */}
                                              {availableAgents.filter(agent => agent.user_id !== userId).map((agent) => (
