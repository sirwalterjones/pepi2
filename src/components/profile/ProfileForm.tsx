            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input id="email" type="email" value={agent.email || ''} readOnly disabled className="bg-muted/50" />
                        <p className="text-xs text-muted-foreground">Email cannot be changed here.</p>
                    </div>
                    <div className="space-y-2">
                        <Label htmlFor="badge_number">Badge Number</Label>
                        <Input id="badge_number" {...register("badge_number")} />
                        {errors.badge_number && <p className="text-sm text-destructive">{errors.badge_number.message}</p>}
                    </div>
